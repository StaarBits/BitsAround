...
public class DeleteHttpMethodExecutor extends HttpMethodExecutor<JsonObject>
{
  
  /** Constructs a new <code>DeleteHttpMethodExecutor</code> */
  public DeleteHttpMethodExecutor(int timeout, @NotNull URL link)
  {
    super("DELETE", timeout, link);
  }
