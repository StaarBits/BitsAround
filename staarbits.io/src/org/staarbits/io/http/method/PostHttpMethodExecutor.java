...
public class PostHttpMethodExecutor extends HttpMethodExecutor<JsonObject>
{
  ...
  /** Constructs a new <code>PostHttpMethodExecutor</code> */
  public PostHttpMethodExecutor(int timeout, @NotNull URL link, @NotNull JsonObject jsonObject)
  {
