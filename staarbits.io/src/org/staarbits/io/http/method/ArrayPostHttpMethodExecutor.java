...
import org.staarbits.io.json.JsonArray;
...
public class ArrayPostHttpMethodExecutor extends HttpMethodExecutor<JsonArray>
{
  ...
  /** The <code>JsonObject</code> which is posted through this method */
  @NotNull
  private JsonObject jsonObject;
  
  /** Constructs a new <code>ArrayPostHttpMethodExecutor</code> */
  public ArrayPostHttpMethodExecutor(int timeout, @NotNull URL link, @NotNull JsonObject jsonObject)
  {
    super("POST", timeout, link);
    this.jsonObject = jsonObject;
  }
  
  /**
   * Gets the <code>JsonObject</code> which is posted through this method when the <code>{@link #execute() execute()}</code>
   * method is invoked.
   * @return The <code>JsonObject</code> instance.
   */
  @NotNull
