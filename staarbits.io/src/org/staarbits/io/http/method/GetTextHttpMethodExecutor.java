...
public class GetTextHttpMethodExecutor extends HttpMethodExecutor<String>
{
 
  /** Constructs a new <code>GetTextHttpMethodExecutor</code> */
  public GetTextHttpMethodExecutor(int timeout, @NotNull URL link)
  {
  ...
  /** {@inheritDoc} */
  @Override
  public String execute() throws HttpRequestFailException
  {
