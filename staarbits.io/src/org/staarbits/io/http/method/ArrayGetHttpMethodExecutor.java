...
public class ArrayGetHttpMethodExecutor extends HttpMethodExecutor<JsonArray>
{
  
  /** Constructs a new <code>ArrayGetHttpMethodExecutor</code> */
  public ArrayGetHttpMethodExecutor(int timeout, @NotNull URL link)
  {
  ...
  public JsonArray execute() throws HttpRequestFailException
  {
    ...
    try
    {
      ...
      ((HttpURLConnection) connection).setRequestProperty("Content-Type", "application/json");
