 ...
 * or <code>{@link ElementType#PARAMETER parmater}</code>) may be equivalent <code><strong><b>null</b></strong></code>,
 * or when declared on a <code>{@link ElementType#METHOD method}</code>, the returning-type of the method might be
 * equivalent to <code><strong><b>null</b></strong></code>.
 */
@Retention(RUNTIME)
@DataAs("@Nullable")
